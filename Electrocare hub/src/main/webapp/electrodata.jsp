...
try
{
	...
	String str=("select * from electrocarerequests");
	...
	while(rs.next())
	{
		...
		<td style="font-weight: bold"><a href="mail.jsp" class="signup-image-link">Reply</a></td>
...
try
{
	...
	String str=("select * from electrocarereplace");
	rs=smt.executeQuery(str);
	while(rs.next())
	{
		%>
