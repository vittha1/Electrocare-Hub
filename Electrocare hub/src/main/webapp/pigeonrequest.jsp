...
<div class="container">
  <img class="logo" src="picture/pigeon.png" alt="Logo">
  <div class="form-container">
    <h2>Pigeon Request Form</h2>
    <form id="supportForm" method="post" action="PigeonRequest">
...
<footer>
	...
	if(status=="success")
		{
		swal("Congrats", "Application Submitted Succesfully", "success");
		}
	</script>
</body>
</html>
